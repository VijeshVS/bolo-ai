...
// Google Gemini pricing (as of 2024) - using Gemini 2.0 Flash
const COST_PER_INPUT_TOKEN = 0.075 / 1000000; // $0.075 per 1M input tokens
const COST_PER_OUTPUT_TOKEN = 0.3 / 1000000; // $0.3 per 1M output tokens
...
export class GoogleProcessor implements LLMProcessor {
  ...
  constructor(apiKey?: string, model?: string) {
    ...
    this.model = model || process.env.GOOGLE_MODEL || "gemini-2.0-flash";
  }
