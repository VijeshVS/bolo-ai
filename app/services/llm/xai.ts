...
// Grok pricing (via xai.com) - using OpenAI-compatible API
const COST_PER_INPUT_TOKEN = 0.005 / 1000; // Estimate
const COST_PER_OUTPUT_TOKEN = 0.015 / 1000; // Estimate
...
export class XAIProcessor implements LLMProcessor {
  ...
  constructor(apiKey?: string, model?: string) {
    ...
    this.model = model || process.env.XAI_MODEL || "grok-2-latest";
  }
